...
# Removing extra spaces, Capitalizing all characters, and removing unwanted characters
...
serial_number = "90210"
# Checking string for anything other than numbers (Letters or Special Keys)
